...
const channelUsername = "@testirafaxxx";
const groupUsername = "@gbrafax";
...
const botName = "rafa"; // Keyword panggilan bot
...
const startImageUrl = 'https://files.catbox.moe/1mrgbt.jpg';
const panelImageUrl = 'https://files.catbox.moe/1mrgbt.jpg';
const ownerImageUrl = 'https://files.catbox.moe/1mrgbt.jpg';
const fiturImageUrl = 'https://files.catbox.moe/1mrgbt.jpg';
const cekIdImageUrl = 'https://files.catbox.moe/1mrgbt.jpg';
const qrisImageUrl = 'https://files.catbox.moe/ijq7gj.jpg';
const groupUrl = 'https://chat.whatsapp.com/IbLbagzflGJB5VihxpC9z0'; // URL grup Telegram
const chanelUrl = 'https://whatsapp.com/channel/0029Vajny6c4tRs0qnwveJ0s'; // Url chanel Telegram
const panelUrl = 'https://files.catbox.moe/1mrgbt.jpg'; // Set Url Data Panel
const webUrl = 'https://websiteprodukxrafatharcode.vercel.app';
const allpayUrl = 'https://allpayyrafatharcode.vercel.app';
...
// ✅ Data Informasi
const nama = '𝙍𝙖𝙛𝙖𝙩𝙝𝙖𝙧𝘾𝙤𝙙𝙚444 𝘿𝙚𝙫';
const author = '𝙍𝙖𝙛𝙖𝙩𝙝𝙖𝙧𝘾𝙤𝙙𝙚444 𝘿𝙚𝙫';
const donasiData = {
    pesan: `𝘽𝙤𝙩 𝘽𝙚𝙧𝙝𝙖𝙨𝙞𝙡 𝙉𝙮𝙖𝙡𝙖 😉.\n𝙊𝙬𝙣𝙚𝙧 𝙎𝙘𝙧𝙞𝙥𝙩 ${author}`
};
...
〤 Bot ini dibuat oleh @RafatharCode.  
...
\`\`\`
Haii ${username},
〤 Ini Adalah Metode Pembayaran RafatharCode.
...
`\`\`\`
Haii ${username},
Ini adalah informasi contact RafatharCode.
...
\`\`\``;
    ...
    const options = {
        reply_markup: {
            inline_keyboard: [
                [
                    { text: '➕ Add Group', url: 'https://t.me/RafatharCodeTeleV3_Bot?startgroup=true' },
                    { text: '➕ Add Channel', url: 'https://t.me/RafatharCodeTeleV3_Bot?startchannel=true' }
                ],
                [{ text: '🔙 Kembali', callback_data: 'starttt_menu' }]
            ]
        }
...
bot.onText(/\/backup/, async (msg) => {
    ...
    try {
        ...
        // Buat arsip zip
        execSync(`zip -r rafatelev4prib.zip ${ls.join(" ")}`);
        ...
        await bot.sendDocument(owner, "./rafatelev4prib.zip", {
            caption: "📁 Backup Script rafatelev4prib.zip",
        }).catch(async (err) => {
        ...
        // Hapus file zip
        execSync("rm -rf rafatelev4prib.zip");
    } catch (error) {
...
==============================
Terima kasih sudah order di RafatharCode 😁✌️
                `;
...
bot.onText(/\/installpanel1 (.+)/, async (msg, match) => {
  ...
  function handleNodeCreationInput(data, stream, domainnode, ramvps) {
    const inputs = [
      `${Tokeninstall}`, '4', 'SGP', 'Jangan Lupa Support RafatharCode🦅🇮🇩',
...
const ownerUsername = "RafatharCode";
...
async function addNumberToDatabase(newNumber) {
    ...
    try {
        ...
        if (!jsonData.dbny.includes(newNumber)) {
            ...
            return `✅ Nomor ${newNumber} berhasil ditambahkan ke database!`;
        } else {
            return `⚠️ Nomor ${newNumber} sudah ada di database.`;
        }
    } catch (error) {
...
async function delNumberFromDatabase(targetNumber) {
    ...
    try {
        ...
        if (jsonData.dbny.includes(targetNumber)) {
            ...
            return `✅ Nomor ${targetNumber} berhasil dihapus dari database!`;
        } else {
            return `⚠️ Nomor ${targetNumber} tidak ditemukan di database.`;
        }
    } catch (error) {
        console.error('❌ Gagal memperbarui database:', error.message);
        throw new Error('Gagal memperbarui database.');
...
console.log(chalk.yellow.bold('bot Add Database v10 berhasil tersambung!!'));
console.log(' ');
console.log(' ');
console.log(chalk.blue.bold('Contact Dev:'));
console.log(chalk.yellow.bold('WhatsApp: +6285864743922'));
console.log(chalk.yellow.bold('Telegram: @RafatharCode'));
